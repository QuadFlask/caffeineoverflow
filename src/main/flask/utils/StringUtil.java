...
public class StringUtil {
	...
	public static String zeroPadding(int n, int digit) {
		String r = "" + n;
		int l = r.length();
		if (l >= digit) {
	...
	public static String paddingWith(int n, int digit, String pad) {
		String r = "" + n;
		int l = r.length();
		if (l >= digit) {
	...
	public static String zeroPadding(long n, int digit) {
		String r = "" + n;
		int l = r.length();
		if (l >= digit) {
	...
	public static String zeroPadding(String s, int digit) {
		int l = s.length();
		if (digit <= l) return s;
		digit = digit - l;
	...
	public static String hexToText(String hex) {
		hex = hex.replace("0x", "");
		if (hex.length() < 2 || hex.length() % 2 == 1) return null;
		char c = 0;
		String full = "";
		String t;
